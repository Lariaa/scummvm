...
// SetMouse(integer x, integer y) warps the cursor to the given screen
// coordinates. Games use it to reposition the cursor during drag interactions
// and to snap it onto answer sprites, so implement it for real (mirroring the
// existing MoveMouse/Putcurs xlibs) rather than stubbing it out.
